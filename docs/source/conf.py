...
.. |link_video_arduino| raw:: html
    ...
    <a href="https://www.youtube.com/playlist?list=PLVTsfY7Kr9qhzrfkvEuI1JhbqoOuchmKw" target="_blank">Arduinoビデオコース</a>
...
.. |link_Ultimate_Sensor_Kit| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/sunfounder-ultimate-sensor-kit-with-original-arduino-uno-r4-minima?_pos=7&_sid=8489ed41c&_ss=r" target="_blank"> Ultimate Sensor Kitの購入リンク</a>
